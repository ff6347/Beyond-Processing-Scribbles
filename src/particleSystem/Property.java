...
public class Property {
	...
	/**
	 * @param extProp clone another {@code Property}
	 */
	...
	/**
	 * @return all daytime values from the Class {@code Property} as a {@code float[]}
	 */
	...
	/**
	 * @return all nitetime values from the Class {@code Property} as a {@code float[]}
	 */
